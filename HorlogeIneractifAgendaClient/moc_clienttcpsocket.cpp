...
void ClientTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientTcpSocket::emmetreMessageRecu)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientTcpSocket::emmetreConnecE)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ClientTcpSocket::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientTcpSocket::emmetreDeconnection)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject ClientTcpSocket::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ClientTcpSocket.data,
      qt_meta_data_ClientTcpSocket,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
