...
#include "../HorlogeIneractifAgendaClient/rdv.h"
...
void Rdv::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Rdv::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Rdv::emmetreModif)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Rdv::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Rdv.data,
      qt_meta_data_Rdv,  qt_static_metacall, nullptr, nullptr}
};
